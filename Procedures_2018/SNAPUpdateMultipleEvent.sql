CREATE DEFINER=`asharma`@`%` PROCEDURE `SNAPUpdateMultipleEvent`(
	IN `date_range` INT
...
d.`id`
FROM
AetnaPrint_2018.event_latest_2018 d
JOIN
(
SELECT 
...
FROM AetnaPrint_2018.event_latest_2018 e 
...
FROM
AetnaPrint_2018.event_latest_2018 d, AetnaPrint_2018.event_latest_2018 e 
...
SELECT
 d1.`id` 
FROM
AetnaPrint_2018.event_latest_2018 d1, AetnaPrint_2018.event_latest_2018 e1 
