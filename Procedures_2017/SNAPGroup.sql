CREATE DEFINER=`asharma`@`%` PROCEDURE `SNAPGroup`()
BEGIN
/*
-----------UPDATE REPORT QUERY------------
*/
		...
		block2:begin
			...
			DECLARE cur2 cursor for
				...
				-- cur2 content
					...
					value (pid, sfid, report_date, gid, replace(gdate, ',', ', '), lower(gtime),Publication, zipcode, County, State,null);
                        ...
                        LIMIT tempNum, 5
							...
							-- insert into report table
							insert into `report_by_id_group_2017`
							value (pid, sfid, report_date, gid2, replace(gdate2, ',', ', '), lower(gtime),Publication, zipcode, County, State,null);
